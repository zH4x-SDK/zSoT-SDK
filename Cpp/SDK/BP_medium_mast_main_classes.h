...
public:
	...
	class UChildActorComponent*                        BP_ShipFlagCustomizationChest;                             // 0x0A40(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData, NonTransactional, NoDestructor)
	...
	class UChildActorComponent*                        BP_BellLower;                                              // 0x0A50(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData, NonTransactional, NoDestructor)
	class UStaticMeshComponent*                        BellSupportLower;                                          // 0x0A58(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData, NonTransactional, NoDestructor)


	static UClass* StaticClass()
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass BP_medium_mast_main.BP_medium_mast_main_C");
		return ptr;
	}
