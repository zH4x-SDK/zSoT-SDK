...
{
public:
	unsigned char                                      UnknownData_6C46[0x4];                                     // 0x0A1C(0x0004) Fix Super Size
	...
	unsigned char                                      UnknownData_3QWF[0x7];                                     // 0x0A39(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_4JSZ[0x3];                                     // 0x0A49(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
