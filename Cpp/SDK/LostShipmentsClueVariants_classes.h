...
{
public:
	unsigned char                                      UnknownData_ZYO1[0x18];                                    // 0x0028(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TMap<class UClueDestinationDescriptor*, int16_t>   ExistingDestinations;                                      // 0x0040(0x0050) (ZeroConstructor, Transient)
	unsigned char                                      UnknownData_7VR6[0x50];                                    // 0x0090(0x0050) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_OCO1[0x20];                                    // 0x00C8(0x0020) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_7BFT[0x20];                                    // 0x0110(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData_7AOE[0x80];                                    // 0x0150(0x0080) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_H3EQ[0x40];                                    // 0x0148(0x0040) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_H4W3[0x10];                                    // 0x0770(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_UT3C[0xF];                                     // 0x07A1(0x000F) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_8PFL[0x2C];                                    // 0x0044(0x002C) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_SJ5H[0x10];                                    // 0x00C8(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_TO9B[0x7];                                     // 0x00F1(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_TJM6[0x7];                                     // 0x0101(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TArray<struct FMapTextureRenderData>               ClueRenderData;                                            // 0x0108(0x0010) (ZeroConstructor)
	unsigned char                                      UnknownData_WNKG[0x48];                                    // 0x0118(0x0048) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_NAJJ[0x4];                                     // 0x0820(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FMapRadialIconData                          MapRadialIconData;                                         // 0x0840(0x0018) (Net, RepNotify)
	unsigned char                                      UnknownData_D77X[0x8];                                     // 0x0858(0x0008) MISSED OFFSET (PADDING)
...
public:
	struct FVector                                     SpawnLocation;                                             // 0x0038(0x000C) (ZeroConstructor, IsPlainOldData, NoDestructor)
	unsigned char                                      UnknownData_17KF[0x2C];                                    // 0x0044(0x002C) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_V2MY[0x8];                                     // 0x00C8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_0NJ1[0x7];                                     // 0x00D1(0x0007) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_41IY[0x7];                                     // 0x0041(0x0007) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_KSNL[0x4];                                     // 0x0054(0x0004) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_Q4UN[0x8];                                     // 0x0468(0x0008) Fix Super Size
	unsigned char                                      UnknownData_DK0R[0x10];                                    // 0x0470(0x0010) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_W32N[0x4];                                     // 0x0044(0x0004) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_RCT1[0x30];                                    // 0x00F0(0x0030) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_76SM[0x8];                                     // 0x0138(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_UVUO[0x70];                                    // 0x0150(0x0070) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_PFSS[0x4];                                     // 0x004C(0x0004) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_F4GX[0x18];                                    // 0x0060(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TArray<class UClueDescriptor*>                     ObtainedClues;                                             // 0x0078(0x0010) (ZeroConstructor, Transient)
	unsigned char                                      UnknownData_BO3C[0x50];                                    // 0x0088(0x0050) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TMap<class UClueDescriptor*, class AActor*>        DiscovererMap;                                             // 0x00D8(0x0050) (ZeroConstructor, Transient)
	unsigned char                                      UnknownData_ROCD[0x120];                                   // 0x0128(0x0120) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FText                                       TitleText;                                                 // 0x0248(0x0018) ELEMENT_SIZE_MISMATCH (Transient)
	unsigned char                                      UnknownData_CM7S[0x20];                                    // 0x0128(0x0020) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
public:
	...
	unsigned char                                      UnknownData_D0TX[0x4];                                     // 0x0028(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	TAssetPtr<class UClass>                            CircleMapItem;                                             // 0x0048(0x001C) ELEMENT_SIZE_MISMATCH (Edit, UObjectWrapper, HasGetValueTypeHash)
	unsigned char                                      UnknownData_ICI3[0x4];                                     // 0x0048(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
public:
	...
	unsigned char                                      UnknownData_OTK5[0x38];                                    // 0x0098(0x0038) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_O97L[0x4];                                     // 0x0030(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData_MQII[0x4];                                     // 0x006C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	unsigned char                                      UnknownData_468P[0x8];                                     // 0x0058(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_WNI9[0x40];                                    // 0x00A0(0x0040) MISSED OFFSET (PADDING)
...
public:
	...
	struct FTransform                                  SpawnTransform;                                            // 0x0060(0x0030) (IsPlainOldData, NoDestructor)
	unsigned char                                      UnknownData_WQSH[0x30];                                    // 0x0090(0x0030) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_DR96[0x4];                                     // 0x0040(0x0004) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData_JSV1[0x4];                                     // 0x006C(0x0004) MISSED OFFSET (PADDING)
