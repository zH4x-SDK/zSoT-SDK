...
struct FWieldableMysteriousNoteLayoutItem
{
	...
	unsigned char                                      UnknownData_AVAI[0x4];                                     // 0x009C(0x0004) MISSED OFFSET (PADDING)
...
struct FMysteriousNoteInfo
{
	...
	unsigned char                                      UnknownData_PTXP[0x2];                                     // 0x0012(0x0002) MISSED OFFSET (PADDING)
...
struct FClientNoteData
{
	...
	unsigned char                                      UnknownData_0J69[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FPlayerMysteriousNoteItem
{
	...
	unsigned char                                      UnknownData_RXTK[0x8];                                     // 0x0040(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_BYC7[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FEventTriggerMysteriousNotesPopup
{
	...
	unsigned char                                      UnknownData_NMBB[0x7];                                     // 0x0009(0x0007) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_IF7L[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_SVAU[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_CGYX[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_P023[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (PADDING)
