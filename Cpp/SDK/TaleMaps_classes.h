...
{
public:
	unsigned char                                      UnknownData_RFDN[0x20];                                    // 0x0088(0x0020) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_601F[0x20];                                    // 0x0088(0x0020) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_MSGW[0x3];                                     // 0x0039(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	unsigned char                                      UnknownData_9ECB[0x30];                                    // 0x0098(0x0030) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_PHYT[0x48];                                    // 0x0088(0x0048) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_OW97[0x40];                                    // 0x0088(0x0040) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_6O33[0x30];                                    // 0x0088(0x0030) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_ORP1[0x8];                                     // 0x0088(0x0008) MISSED OFFSET (PADDING)
