...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function BP_Projectile_CannonBall_Cursed_ComplexWaterHits.BP_Projectile_CannonBall_Cursed_ComplexWaterHits_C.UserConstructionScript");
