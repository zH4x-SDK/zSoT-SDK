...
// BlueprintGeneratedClass BP_MerchantCrate_WoodCrate_FullyStocked_ItemInfo.BP_MerchantCrate_WoodCrate_FullyStocked_ItemInfo_C
// 0x0018 (FullSize[0x0730] - InheritedSize[0x0718])
class ABP_MerchantCrate_WoodCrate_FullyStocked_ItemInfo_C : public ABootyItemInfo
{
public:
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass BP_MerchantCrate_WoodCrate_FullyStocked_ItemInfo.BP_MerchantCrate_WoodCrate_FullyStocked_ItemInfo_C");
		return ptr;
	}
