...
public:
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass BP_MediumShip_StandardHull_InternalShipWater.BP_MediumShip_StandardHull_InternalShipWater_C");
		return ptr;
	}
