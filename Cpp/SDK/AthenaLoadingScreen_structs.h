...
{
	unsigned char                                      UnknownData_LI4Z[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_5707[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_Z1JV[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
