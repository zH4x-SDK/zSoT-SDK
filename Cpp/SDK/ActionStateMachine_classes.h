...
{
public:
	unsigned char                                      UnknownData_K3N9[0x18];                                    // 0x03D0(0x0018) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_OVJQ[0x18];                                    // 0x00C8(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_8HK4[0x768];                                   // 0x00F0(0x0768) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_NBXS[0x18];                                    // 0x0858(0x0018) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_6UIJ[0x7];                                     // 0x0029(0x0007) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_MGMX[0x10];                                    // 0x03D8(0x0010) MISSED OFFSET (PADDING)
