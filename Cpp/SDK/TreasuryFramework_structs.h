...
struct FTreasuryWaveEncounter
{
	...
	unsigned char                                      UnknownData_O5HW[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_SOFF[0x7];                                     // 0x0029(0x0007) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_72S7[0x18];                                    // 0x0000(0x0018) MISSED OFFSET (PADDING)
