...
public:
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass figurehead_thunderpack_01_v01_CustomizationDesc.figurehead_thunderpack_01_v01_CustomizationDesc_C");
		return ptr;
	}
