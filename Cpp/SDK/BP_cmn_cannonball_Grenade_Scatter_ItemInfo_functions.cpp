...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function BP_cmn_cannonball_Grenade_Scatter_ItemInfo.BP_cmn_cannonball_Grenade_Scatter_ItemInfo_C.UserConstructionScript");
