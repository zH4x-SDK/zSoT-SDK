...
{
public:
	unsigned char                                      UnknownData_S3M9[0x38];                                    // 0x0028(0x0038) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_H2DU[0x28];                                    // 0x0028(0x0028) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      pad_UFPC4GEARZ[0x40];                                      // 0x0048(0x0040) NOT AUTO-GENERATED PROPERTY
...
{
public:
	unsigned char                                      UnknownData_XWKH[0x10];                                    // 0x0088(0x0010) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_RMHO[0x58];                                    // 0x0028(0x0058) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_DURJ[0x138];                                   // 0x0088(0x0138) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      pad_DJZR1HEFMY[0x04];                                      // 0x00AC(0x0004) NOT AUTO-GENERATED PROPERTY
	void*                                              Func;                                                      // 0x00B0(0x0008) NOT AUTO-GENERATED PROPERTY
	unsigned char                                      pad_ZCWR0UNBUF[0x8];                                       // 0x00B8(0x0008) NOT AUTO-GENERATED PROPERTY
...
{
public:
	unsigned char                                      UnknownData_SX1E[0x10];                                    // 0x00B8(0x0010) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_EKNL[0x28];                                    // 0x0028(0x0028) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_2TDP[0x28];                                    // 0x0030(0x0028) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_G7P5[0x150];                                   // 0x01C0(0x0150) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_54XG[0x60];                                    // 0x0028(0x0060) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_GJBD[0x150];                                   // 0x00B8(0x0150) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_3686[0x50];                                    // 0x0028(0x0050) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_5193[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_IYN5[0x40];                                    // 0x0030(0x0040) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_CI56[0x8];                                     // 0x0070(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_O22E[0x8];                                     // 0x0070(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_T4BU[0x8];                                     // 0x0078(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_6MSI[0x8];                                     // 0x0070(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_7LDJ[0x8];                                     // 0x0070(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_VXLH[0x8];                                     // 0x0078(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_LRPA[0x8];                                     // 0x0070(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_TJHR[0x8];                                     // 0x0070(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_TU2X[0x38];                                    // 0x0070(0x0038) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_801O[0x8];                                     // 0x0070(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_Q7U8[0x8];                                     // 0x0070(0x0008) MISSED OFFSET (PADDING)
