...
struct FModeSpecificReviveSettings
{
	...
	unsigned char                                      UnknownData_4V9U[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FReviveEffectsValues
{
	...
	unsigned char                                      UnknownData_XZ8C[0x18];                                    // 0x0008(0x0018) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_BMG6[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_GPDI[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FReviveableActionStateConstructionInfo : public FActorActionStateConstructionInfo
{
	...
	unsigned char                                      UnknownData_1GQJ[0x6];                                     // 0x0062(0x0006) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_CY04[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_EUP4[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_35U1[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_9LRK[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_JF9T[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_GF7N[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_V73V[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_BUXU[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_6C8B[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_IDXG[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_IFWS[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
struct FRevivingWindowStart
{
	...
	unsigned char                                      UnknownData_MW75[0x7];                                     // 0x0029(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
