...
public:
	...
	unsigned char                                      UnknownData_T6IL[0xA8];                                    // 0x0038(0x00A8) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_ONSU[0x38];                                    // 0x00E8(0x0038) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_L4Z2[0x6];                                     // 0x00CA(0x0006) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_SWDD[0x1C];                                    // 0x00F4(0x001C) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_5AQK[0x2];                                     // 0x0032(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
