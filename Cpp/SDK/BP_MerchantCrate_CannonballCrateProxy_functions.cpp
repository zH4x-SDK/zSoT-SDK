...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function BP_MerchantCrate_CannonballCrateProxy.BP_MerchantCrate_CannonballCrateProxy_C.UserConstructionScript");
