...
struct FSeasonIconPopupAsset
{
	...
	unsigned char                                      UnknownData_RV9X[0x4];                                     // 0x0064(0x0004) MISSED OFFSET (PADDING)
...
struct FSeasonGoalPopupAsset
{
	...
	unsigned char                                      UnknownData_RC5V[0x4];                                     // 0x007C(0x0004) MISSED OFFSET (PADDING)
...
struct FSeasonProgressionUIEventTypeTelemetryFragment
{
	...
	unsigned char                                      UnknownData_94UQ[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (PADDING)
...
struct FNavigationDesc
{
	...
	unsigned char                                      UnknownData_PPC7[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FSeasonProgressionUITelemetryFragment
{
	...
	unsigned char                                      UnknownData_US05[0x4];                                     // 0x0014(0x0004) MISSED OFFSET (PADDING)
...
struct FEnableMoreButtonEvent
{
	...
	unsigned char                                      UnknownData_KRCH[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FSeasonNotificationContent
{
	...
	unsigned char                                      UnknownData_ZRXA[0x4];                                     // 0x0064(0x0004) MISSED OFFSET (PADDING)
...
struct FDeedProgressDesc
{
	...
	unsigned char                                      UnknownData_30RD[0x4];                                     // 0x003C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FOpenSeasonsMenuEvent
{
	...
	unsigned char                                      UnknownData_EMTC[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FGuid                                       Id;                                                        // 0x0004(0x0010) (ZeroConstructor, IsPlainOldData, NoDestructor)
...
struct FSeasonsPopupEvent
{
	...
	unsigned char                                      UnknownData_4DY2[0x4];                                     // 0x009C(0x0004) MISSED OFFSET (PADDING)
