...
// BlueprintGeneratedClass bsp_torch_a_a.bsp_torch_a_a_C
// 0x0018 (FullSize[0x03F8] - InheritedSize[0x03E0])
class Absp_torch_a_a_C : public AStaticMeshActor
{
public:
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass bsp_torch_a_a.bsp_torch_a_a_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_bsp_torch_a_a(int EntryPoint);
};
