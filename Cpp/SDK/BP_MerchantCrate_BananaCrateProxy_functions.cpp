...
{
	static UFunction* fn = UObject::FindObject<UFunction>("Function BP_MerchantCrate_BananaCrateProxy.BP_MerchantCrate_BananaCrateProxy_C.UserConstructionScript");
