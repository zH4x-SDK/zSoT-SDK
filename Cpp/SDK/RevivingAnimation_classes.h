...
{
public:
	unsigned char                                      UnknownData_3S3J[0x8];                                     // 0x0440(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_NNPO[0x1D];                                    // 0x0473(0x001D) MISSED OFFSET (PADDING)
