...
public:
	...
	{
		static UClass* ptr = UObject::FindClass("BlueprintGeneratedClass BP_MerchantCrate_CannonballCrate_FullyStocked_Desc.BP_MerchantCrate_CannonballCrate_FullyStocked_Desc_C");
		return ptr;
	}
